...
SUPPORTED_FAN_MODES_OPTIONS = {
    ...
    "TURBO": ClimateMode.CLIMATE_FAN_TURBO,
}
    ...
    climate.CLIMATE_SCHEMA.extend(
        {
            ...
            cv.Optional(CONF_SUPPORTED_FAN_MODES,default=["AUTO","QUIET","LOW","MEDIUM","HIGH","FOCUS","DIFFUSE",],): cv.ensure_list(cv.enum(SUPPORTED_FAN_MODES_OPTIONS, upper=True)),
        }
    )
